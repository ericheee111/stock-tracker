...
> 适用市场：A股 / 港股 / 美股  
> 当前用户主画像（2026-09-11 已确认）：几周到几个月的波段，期间做 T，另有部分长持和短线；持仓管理与新机会发现并重。不同市场仍独立验证。下文短周期实验属于已有研究基线，不再定义产品主周期或强制持有上限；多周期与 T 口径见 `PRODUCT-TRADING-PROFILE-20260911.md`。
...
2026-09-11 更新：下列 3/5/10/20 日窗口保留原实验身份，不自动改写。新波段研究可对照 20/40/60 日及更长窗口，具体值尚待验证；长持、独立短线与 T 分开定义标签，不能将做 T 一轮结果计作新的波段样本。持有周期不是标签到期强制退出规则。
